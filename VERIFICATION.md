...
- Action Commands: **128**
- Athletic Commands: **7**
- New July 17 batch: **97** successful motions in exact execution order
- New batch encoded size: **274.18 MiB**
- Encoding: H.264 (`avc1`), 1600×1200, 30 fps, full-range 4:2:0 (`yuvj420p`), fast-start MP4
- Full video decode: passed with zero FFmpeg errors for every file
- Visual and automated motion review: passed; no still-image substitutes or idle-only clips
- Transfer integrity: every Windows file exactly matches its Mac SHA-256 value
